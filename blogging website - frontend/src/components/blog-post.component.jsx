...
const BlogPostCard = ({ content , author }) => {
    ...
    let { blog_id : id, title, des, banner, activity : { total_likes}, tags, publishedAt } = content;
    ...
    return(
        <Link to={`/blog/${id}`} className="flex gap-8 items-center border-b border-grey pb-5 mb-4 ">
            ...
            <div className="h-28 aspect-square bg-grey">
                <img src={banner} className="w-full h-full aspect-square  object-cover" alt="banner imag" />
            </div>
        </Link>
