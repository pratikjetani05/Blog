...
function BlogContent({block}) {
    ...
    if(type === "header"){
      if(data.level === 3){
        return <h3 className='tetxt-3xl font-bold' dangerouslySetInnerHTML={{__html: data.text}}></h3>
      }
      return <h2 className='tetxt-4xl font-bold' dangerouslySetInnerHTML={{__html: data.text}}></h2>
    }
